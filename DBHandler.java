...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_MEANING = "phone_number";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                ...
                + KEY_MEANING + " TEXT," +KEY_STAR +" TEXT,"+KEY_VOICE+" TEXT"+")";
    ...
    Contacts getContact(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[]{KEY_ID,
                        KEY_WORD_NAME, KEY_MEANING,KEY_STAR,KEY_VOICE}, KEY_ID + "=?",
    ...
    public List<Contacts> getAllContacts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setStar(cursor.getString(3));
                contact.setVoice(cursor.getString(4));
